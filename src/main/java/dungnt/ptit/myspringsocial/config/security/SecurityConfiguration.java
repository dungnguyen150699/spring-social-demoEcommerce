...
//                    .authorizationRequestRepository(cookieAuthorizationRequestRepository())
        ...
        http
                .authorizeHttpRequests((auth) -> {
                    ...
                    auth.antMatchers("/mvc","/mvc/shop","/mvc/cart","/mvc/order").hasAnyAuthority("USER","ADMIN"); // ** Ý là link ko nên viết trùng tên, mà viết thêm role vào
                    auth.antMatchers("/mvc","/mvc/**").hasAnyAuthority("ADMIN"); // check link for only admin -> link role user will not work
